...
{
  push_heap_aux(first, last, DISTANCETYPE(first), VALUETYPE(first));
}
...
template <class RandomAccessIterator, class Distance, class T>
void 
adjust_heap(RandomAccessIterator first, Distance holeIndex, Distance len, T value)
{
...
inline void 
pop_heap(RandomAccessIterator first, RandomAccessIterator last, RandomAccessIterator result, T value, Distance*)
{
  *result = *first;
...
inline void 
pop_heap_aux(RandomAccessIterator first, RandomAccessIterator last, T*)
{
...
{
  pop_heap_aux(first, last, VALUETYPE(first));
}
...
template <class RandomAccessIterator, class T, class Distance>
void 
make_heap(RandomAccessIterator first, RandomAccessIterator last, T*, Distance*)
{
...
{
  make_heap(first, last, VALUETYPE(first), DISTANCETYPE(first));
}
